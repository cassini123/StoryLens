...
const zh = {
  ...
  introTitle: '说明',
  completeTitle: '实验结束',
  completeLead: '谢谢。请下载本次数据，交给实验员。也可以点 Surprise，展开一张可下载的致谢卡片。',
  downloadData: '下载我的实验数据',
  surprise: 'Surprise',
  thanksCardTitle: '致谢卡片',
  thanksDownloadPng: '下载 PNG',
  thanksDownloadJpg: '下载 JPG',
  thanksClose: '关闭',
  home: '首页',
  error: '出错了',
  noTask: '当前没有进行中的题目。',
...
const en: Copy = {
  ...
  completeLead: 'Thank you. Please download your session data and give the file to the experimenter. You can also click Surprise to open a downloadable thank-you card.',
  downloadData: 'Download my session data',
  surprise: 'Surprise',
  thanksCardTitle: 'Thank-you card',
  thanksDownloadPng: 'Download PNG',
  thanksDownloadJpg: 'Download JPG',
  thanksClose: 'Close',
  home: 'Home',
  error: 'Error',
