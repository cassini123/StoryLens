...
const zh = {
  ...
  introTitle: '说明',
  completeTitle: '实验结束',
  completeLead: '谢谢。本次数据会自动上传到服务器，你也可以再下载一份备份。',
  downloadData: '下载我的实验数据',
  uploadPending: '正在把本次 JSON 上传到服务器…',
  uploadOk: '数据已上传到服务器。实验员可在导出页查看。',
  uploadFail: '上传失败：{error}。请下载备份，或点重试。',
  uploadRetry: '重新上传',
  serverSubmissions: '服务器上的被试数据',
  viewToken: '查看口令',
...
const en: Copy = {
  ...
  completeLead: 'Thank you. This session JSON is uploaded to the server automatically. You can also download a backup.',
  downloadData: 'Download my session data',
  uploadPending: 'Uploading this session JSON to the server…',
  uploadOk: 'Uploaded. Researchers can open it on the Export page.',
  uploadFail: 'Upload failed: {error}. Download a backup or retry.',
  uploadRetry: 'Retry upload',
  serverSubmissions: 'Server submissions',
