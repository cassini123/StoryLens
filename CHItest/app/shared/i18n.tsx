...
const zh = {
  ...
  interpretSketchHint: '拖草图不会自动出字。改完后请点这一按钮，才会根据当前草图生成文字解释。',
  ...
  confirmRestart: '确定，重新开始',
  cancel: '取消',
  resumeOrReroll: '这个编号有未做完的实验。确定 = 继续上次，取消 = 丢掉进度并重新开始。',
  idUsed: '这个编号已经做过完整实验。',
  settings: '设置',
  save: '保存',
  refresh: '刷新',
...
const en: Copy = {
  ...
  interpretSketchHint: 'Dragging the sketch does not write text by itself. Click this button after you edit, and it will turn the current sketch into a written interpretation.',
  ...
  cancel: 'Cancel',
  resumeOrReroll: 'This ID has an unfinished session. OK = resume it, Cancel = discard and start over.',
  ...
  logout: 'Log out',
  surprise: 'Surprise',
  surpriseHint: 'Open the card',
  surpriseDownload: 'Download',
  close: 'Close',
